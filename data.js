...
const PLAYERS = [
  ...
  { name: "Kelevra",         build: "nameless",        altBuild: null,             gearLevel: "high", ready: true,  squad: null, roles: [], note: "" },
  ...
  { name: "BayarD",          build: "strategic",       altBuild: null,             gearLevel: "high", ready: true,  squad: null, roles: [], note: "може замінити спис на стяжку" },
  { name: "Geerion",         build: "nameless",        altBuild: "umbrella_dd",    gearLevel: "high", ready: true,  squad: null, roles: [], note: "" },
  ...
  { name: "Endurist",        build: "nameless",        altBuild: null,             gearLevel: "mid", ready: false, squad: null, roles: [], note: "" },
  { name: "Aiswill",         build: "heal",            altBuild: null,             gearLevel: "mid", ready: false, squad: null, roles: [], note: "" },
];
